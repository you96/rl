...
class RadiolinecoPillow
{
	...
	public function getShowFromStation($country = 'gb', $language = 'en', $locale = 'en_GB', $permalink)
	{
		$permalink = str_replace('-', '_', $permalink);
		$url = $this->pillow_path . 'radios/'.$permalink.'/live';
		...
		$data = json_decode($response->body)->body->content->show;
    ...
    public function getBio($country = 'gb', $language = 'en', $locale = 'en_GB', $permalink){
    	...
    	//$dataName include not only his name also other things, ex:David Guetta
    	if(strpos($dataName,',')>0){
    		$num1 = strpos($dataName,',');
    		$dataName = substr($dataName, 0, $num1);
    	}
	...
	public function getPermalink($name){
		$permalink = str_replace('-','_',str_replace(' ', '_', $name));
		$unwanted_array = array(    'Š'=>'S', 'š'=>'s', 'Ž'=>'Z', 'ž'=>'z', 'À'=>'A', 'Á'=>'A', 'Â'=>'A', 'Ã'=>'A', 'Ä'=>'A', 'Å'=>'A', 'Æ'=>'A', 'Ç'=>'C', 'È'=>'E', 'É'=>'E',
				'Ê'=>'E', 'Ë'=>'E', 'Ì'=>'I', 'Í'=>'I', 'Î'=>'I', 'Ï'=>'I', 'Ñ'=>'N', 'Ò'=>'O', 'Ó'=>'O', 'Ô'=>'O', 'Õ'=>'O', 'Ö'=>'O', 'Ø'=>'O', 'Ù'=>'U',
				'Ú'=>'U', 'Û'=>'U', 'Ü'=>'U', 'Ý'=>'Y', 'Þ'=>'B', 'ß'=>'Ss', 'à'=>'a', 'á'=>'a', 'â'=>'a', 'ã'=>'a', 'ä'=>'a', 'å'=>'a', 'æ'=>'a', 'ç'=>'c',
				'è'=>'e', 'é'=>'e', 'ê'=>'e', 'ë'=>'e', 'ì'=>'i', 'í'=>'i', 'î'=>'i', 'ï'=>'i', 'ð'=>'o', 'ñ'=>'n', 'ò'=>'o', 'ó'=>'o', 'ô'=>'o', 'õ'=>'o',
				'ö'=>'o', 'ø'=>'o', 'ù'=>'u', 'ú'=>'u', 'û'=>'u', 'ý'=>'y', 'ý'=>'y', 'þ'=>'b', 'ÿ'=>'y' );
		$permalink = strtr( $permalink, $unwanted_array );
